...
let shareData = () => {
    ...
    let shareLink = url.protocol + "//" + url.host + url.pathname + "?v="+ version+"&k=k"+ safeEncode(getCurrentStorageListKey().replace(_data_prefix,""))+"&classes=" + safeEncode(_.toString(classList)) 
