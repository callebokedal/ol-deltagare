...
let addList = () => {
    let d = document.getElementById("debugAdd");
    d.innerHTML = "d1";
        ...
        dataPersonLines.forEach((line, idx) => {
            ...
            if(!_.isEmpty(data)) {
                ...
                if(!_.find(appdata.persons, ['name', name])) {
                    d.innerHTML = "d5.5: " + appdata.persons;
                    d.innerHTML = "d5.4: " + appdata.persons;
                    d.innerHTML = "d5.7: " + appdata.persons.length;
                    //d.innerHTML = "d5.5: " + appdata.persons.length + ', ' + JSON.stringify(appdata.persons);
                    //d.innerHTML = "d5.1: " + appdata.persons.length;
