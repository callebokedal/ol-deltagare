...
let updatePersonStats = () => {
    ...
    $('#personStats').html(personStats(
        ...
        'notstarted':_.filter(persons, function(o) { return o.status=="here" && o.run=="unknown"; }).length,
...
let renderPersonsChecklist = () => {
    if(_.isEmpty(appdata.persons)) {
        $('#personsChecklist').html('&nbsp;Inga personer inlagda - <a href="#" style="color:#99ccff;" onclick="showSettings();return false;">Inställningar</a>');
    } else {
